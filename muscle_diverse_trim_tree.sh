...
muscle -align "$align_input" -diversified --output "$alignment_name".efa
muscle -disperse "$alignment_name".efa &> "$alignment_name".div
muscle -maxcc "$alignment_name".efa -output "$alignment_name".afa
